populate_nsprd_tables <- function(pid_list, prd_con, db_con) {
  ...
  append_db_data("parcel_info", pid_info, db_con)
  ...
  append_db_data("parcel_madd", pid_mailing_address, db_con)
  ...
  append_db_data("parcel_padd", pid_address, db_con)
  ...
  append_db_data("landowners", pid_names, db_con)
}
